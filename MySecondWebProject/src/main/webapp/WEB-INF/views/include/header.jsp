...
#sub-1 {
	...
	margin-right: auto;
	background-image:
		url(https://www.kh-academy.co.kr/resources/images/main/main_renewal/sub/sub02/educationinfo/jongro/04.jpg);
...
#sub-2 {
	...
	height: 40%;
	background-image:
		url(https://www.kh-academy.co.kr/resources/images/main/main_renewal/sub/sub02/educationinfo/jongro/05.jpg);
	background-size: cover;
	background-repeat: none;
}
	...
	<nav class="navbar navbar-expand-lg navbar-light fixed-top"
		...
		<div class="container">
			<a class="navbar-brand" href="#"> <img class="img-fluid"
				src="https://www.kh-academy.co.kr/resources/images/main/logo.svg"
				alt="로고없음" style="width: 130px; height: 50px;" />
			</a>
				...
				<ul class="navbar-nav text-uppercase ml-auto">
					...
					<c:choose>
						...
						<c:otherwise>
							...
							<li class="nav-item"><a class="nav-link js-scroll-trigger"
								href="logout" onclick="return confirm('정말 로그아웃 하시겠습니까?')">로그아웃</a>
							</li>
						</c:otherwise>
					</c:choose>
				</ul>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form action="/mswp/sic" name="sign-in" method="post"
						id="signInForm" style="margin-bottom: 0;">
						<table
							...
							<tr>
								<td style="padding-top: 10px; text-align: center">
									<p>
										<strong>로그인하셔서 서비스를 이용해보세요~~!</strong>
									</p>
								</td>
							</tr>
							<tr>
