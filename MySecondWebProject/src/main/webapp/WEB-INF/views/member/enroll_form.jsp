...
<body>
	...
	<div style="width: 80%; margin: auto; padding: 50px;">
		<form action="/mswp/suc" name="signup" id="signUpForm" method="post"
			...
			<table
				...
				<tr>
					<td><input type="password" size="17" maxlength="20"
						id="password" name="memberPw" class="form-control tooltipstered"
				...
				<tr>
					<td style="padding-top: 10px; text-align: center">
						<p>
							<strong>회원가입하셔서 KH 수강생이 되어보세요~~!</strong>
						</p>
					</td>
				</tr>
				<tr>
